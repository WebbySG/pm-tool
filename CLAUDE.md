...
- **Numbering:** `INV-YYYY-NNNN` format, generated by `next_invoice_number(p_year int)` Postgres RPC. Per-year sequence stored in `pm_invoice_counters` — atomic insert/update.
