...
app/(app)/projects/[id]/page.tsx — Project detail, kanban, schedule, files (REAL uploads → pm_project_media + pm-attachments bucket; drag-drop, spinner, error panel), pinned (still local-only), content, weekly reports (pm_weekly_reports)
